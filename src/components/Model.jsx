...
import { animateWithGsapTimelime } from '../utils/animations'
export const Model = () => {
    ...
    //keep track of the model during animations
    ...
    useEffect(()=>{
if(size==='large'){
animateWithGsapTimelime(tl,small,smallRotation,'#view1','#view2',{
    transform:'translateX(-100%)',
    duration:2
})
}
if(size==='small'){
    animateWithGsapTimelime(tl,large,largeRotation,'#view2','#view1',{
                ...
                <div className='flex flex-col items-center mt-5'>
                    <div className='w-full h-[75vh] md:h-[90vh] overflow-hidden relative'>
                        ...
                        <Canvas className='w-full h-full ' style={{
                            ...
                            {/* A way to render multiple views of same canvas  */}
                            <View.Port />
